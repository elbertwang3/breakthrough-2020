  ...
  <nav class="minimal-header__nav">
    <ul class="minimal-header__navlist">
      <li class="minimal-header__navitem">
        <a href="//www.sciencemag.org/">Home</a>
      </li>
      <li class="minimal-header__navitem">
        <a href="//www.sciencemag.org/news/">News</a>
      </li>
      <li class="minimal-header__navitem">
        <a href="//www.sciencemag.org/journals/">Journals</a>
      </li>
      <li class="minimal-header__navitem">
        <a href="//www.sciencemag.org/topics/">Topics</a>
      </li>
      <li class="minimal-header__navitem">
        <a href="//www.sciencemag.org/careers/">Careers</a>
      </li>
    </ul>
  </nav>
  <!-- <div
    ...
    <div
      ...
      aria-labelledby="at-44da61bf-f833-4aea-82d9-00e76304af9f"
      role="region">
      <span
        id="at-44da61bf-f833-4aea-82d9-00e76304af9f"
        ...
        <a
          ...
          style="background-color: rgb(102, 102, 102); border-radius: 26px;"><span
            ...
            style="line-height: 20px; height: 20px; width: 20px;"><svg
              ...
              style="fill: rgb(255, 255, 255); width: 20px; height: 20px;"><title
                id="at-svg-facebook-1">
                Facebook
              </title>
              <g>
                <path
          ...
          style="background-color: rgb(102, 102, 102); border-radius: 26px;"><span
            ...
            style="line-height: 20px; height: 20px; width: 20px;"><svg
              ...
              version="1.1"
              role="img"
              aria-labelledby="at-svg-print-3"
